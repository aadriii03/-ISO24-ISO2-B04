...
public class SistemaGestionDatos {
 ...
 // Método para que un usuario solicite acceso o información de calidad sobre un conjunto de datos
 ...
 // Método para notificar al usuario solicitante sobre la disponibilidad del reporte
